...
$$
for the $t^{\trm{th}}$ parameter update. We have experimented with linear, quadratic and bounded exponential ($\g_0 \rbrac{1 - e^{-\tau t}}$) scoping schedules with similar qualitative results.
